...
import WAULTWIZARD from "/public/assets/Images/WAULTWIZARD.gif"
import WIZARDAUTOSHARK from "/public/assets/Images/WIZARDAUTOSHARK.gif"
...
// import {POOL_CONTRACT} from  "/utils/Config/POOL_CONTRACT"
...
const getVolume = async (_index) => {
  ...
  return (
    <div className={`${styles.font_text} main-bg `}>
							...
							<div className="banner-top-sec">
								...
								<div className="serch-box">
									<div className="input-s-box">
										<input className='relative' onChange={handleSearch}  type="text" />
										<span className=' absolute top-7 left-48'><img src='/assets/Images/search.png' /></span>
									</div>
								</div>
        ...
        <Link href='https://app.wault.finance/bsc/#farm' aria-expanded="true">
        <div className="wrp-bison">
					<div className="bison-c1 bg-bison">
						<div className="img-bison">
              <Image src={WAULTWIZARD} alt="loading gif" width={20} height={20}/>
						</div>
					...
					<div className="bison-btn">
                        {
                          wallet.address ===null?<ConnectButton /> :<button >Deposit</button>
                        }
					</div>
				</div>
        </Link>
      ...
      <div class="panel panel-default">
          ...
          <Link href='https://autoshark.finance/vaults' aria-expanded="true">
				<div className="wrp-bison">
					<div className="bison-c1 bg-bison">
						<div className="img-bison">
              <Image src={WIZARDAUTOSHARK} alt="loading" width={20} height={20}/>
						</div>
